...
class I18N_ru_RU implements I18N {
    static final String[] P = {"Вы", "Левый", "Передний", "Правый"};
    static final String[] C = {
            "Отсутствует", "[К]Красный", "[С]Синий", "[З]Зеленый", "[Ж]Желтый"
    }; // C[]
    ...
    @Override
    public String act_playWild(int i1, int i2) {
        return p(i1) + ": Поменять цвет на " + c(i2);
    } // act_playWild(int, int)
